...
const BLOG = {
  ...
  REDIRECT_LANG: process.env.NEXT_PUBLIC_REDIRECT_LANG || false, // 是否开启语言跳转，开启后根据浏览器语言自动切换语言
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    {
      name: 'Passing Your World',
      artist: 'DelDen',
      url: 'http://music.163.com/song/media/outer/url?id=2085507521.mp3',
      cover:
        'http://p2.music.126.net/R0_RVAHKe1ezVjJ2wUF2rA==/109951168942767444.jpg'
    },
    {
      name: '萤火之森',
      artist: 'CMJ',
      ...
      cover:
        'http://p2.music.126.net/jNh5VIYGzc74RFPMv_TouQ==/109951164615554163.jpg'
    }
  ],
